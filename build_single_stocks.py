...
if __name__ == '__main__':
    ...
    file_folder = os.path.join(root_folder, "original")
    # folders =['91-97', '97-99', '99-04', '04-08', '08-08', '08-09', '09-12', '12-13', '13-15', '15-18', '18-19','19-20', '20-20']
    # folders = ['23']
    # folders = pd.read_csv(stock_name_path, columns=['20-22'])
    ...
    for file in glob(file_folder + '/*.csv'):
    ...
    # for folder in folders:
        ...
        # combined_df.to_csv(os.path.join(root_folder + "/single_stocks/", file_name + '_' + str(file_count) + '.csv'), index=False)
        combined_df.to_csv(os.path.join(root_folder + "/complete_file/", file_name + '.csv'), index=False)
        # file_count += 1
