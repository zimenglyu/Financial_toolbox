...
for ticker in [ 'AXP',  'BA', 'CAT', 'KO', 'IBM','JPM','MCD','MRK','MMM', 'PG','DIS']:
...
# for ticker in ['DWDP']:
    ...
    start_date = '2020-08-31'  # Start of your date range
    end_date = '2022-12-30'    # End of your date range
    ...
    df_date_filtered.to_csv('/Users/zimenglyu/Documents/datasets/CRSP/DJI_history/{}_20-22.csv'.format(ticker), index=False)
